...
var ChatBubble = /** @class */ (function (_super) {
    ...
    ChatBubble.prototype.render = function () {
        ...
        var chatBubbleStyles = __assign({}, styles_1.default.chatBubble, chatBubble, (youAreAuthor ? {} : styles_1.default.recipientChatBubble), (youAreAuthor ? styles_1.default.chatBubbleOrientationNormal : styles_1.default.recipientChatBubbleOrientationNormal), (this.props.isFirstInGroup && (youAreAuthor ? styles_1.default.firstChatBubbleInGroup : styles_1.default.recipientFirstChatBubbleInGroup)), (this.props.isLastInGroup && (youAreAuthor ? styles_1.default.lastChatBubbleInGroup : styles_1.default.recipientLastChatBubbleInGroup)), (this.props.isCenterInGroup && (youAreAuthor ? styles_1.default.centerChatBubbleInGroup : styles_1.default.recipientCenterChatBubbleInGroup)), userBubble);
...
var BubbleGroup = /** @class */ (function (_super) {
    ...
    BubbleGroup.prototype.renderGroup = function (messages, author) {
        ...
        var messageNodes = messages.map(function (message, i) { return (React.createElement(ChatBubble, { key: i, yourAuthorId: _this.props.yourAuthorId, author: author, message: message, bubblesCentered: bubblesCentered, bubbleStyles: bubbleStyles, isFirstInGroup: i === 0, isLastInGroup: i === messages.length - 1 && messages.length > 1, isCenterInGroup: i < messages.length - 1 && messages.length > 1, lastSeenByAuthors: _this.props.authors && _this.props.authors.filter(function (a) { return a.lastSeenMessageId === message.id; }), showRecipientLastSeenMessage: _this.props.showRecipientLastSeenMessage, customLastSeenAvatar: _this.props.customLastSeenAvatar })); });
...
var Avatar_1 = __webpack_require__(3);
var IsTyping_1 = __webpack_require__(9);
var ChatScrollArea_1 = __webpack_require__(10);
var LastSeenAvatar_1 = __webpack_require__(11);
...
var ChatScrollArea = /** @class */ (function (_super) {
    ...
    ChatScrollArea.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { ref: function (scrollContainer) { return _this.scrollContainer = scrollContainer; }, className: "react-chat-ui__chat-history", style: __assign({}, styles.chatHistory, { maxHeight: this.props.maxHeight }) }, this.props.children));
    };
