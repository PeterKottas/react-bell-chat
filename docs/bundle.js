    ...
    ChatBubble.prototype.render = function () {
        ...
        return (React.createElement("div", { style: __assign({}, styles_1.default.chatBubbleWrapper) },
            React.createElement("div", { style: chatBubbleStyles },
                ...
                this.props.message.isSend !== undefined && youAreAuthor && (React.createElement("span", { className: "react-chat-ui__chat-bubble__is-send", style: __assign({}, styles_1.default.isSend), title: this.props.message.isSend ? 'Send' : 'Sending' }, this.props.message.isSend ?
            ...
            this.props.showRecipientLastSeenMessage && this.props.lastSeenByAuthors &&
                ...
                (React.createElement("div", { className: "react-chat-ui__chat-bubble__last-seen-by__container", style: styles_1.default.lastSeenByContainer, onMouseEnter: function () { return _this.setState({ mouseOverLastSeenContainer: true }); }, onMouseLeave: function () { return _this.setState({ mouseOverLastSeenContainer: false }); }, title: 'Last seen by ' + this.props.lastSeenByAuthors.map(function (a) { return a.name; }).join(', ').replace(/,(?!.*,)/gmi, ' and') }, this.props.lastSeenByAuthors.map(function (a, i) { return (React.createElement(_this.props.customLastSeenAvatar, { key: i, author: a, containerStyle: __assign({}, (i > 0 && !_this.state.mouseOverLastSeenContainer ? { marginTop: -12 } : { marginTop: -4 }), { zIndex: 100 + i }) })); })))));
    };
...
var ChatScrollArea = /** @class */ (function (_super) {
    ...
    ChatScrollArea.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: function (scrollContainer) {
            ...
            }, className: "react-chat-ui__chat-history", style: __assign({}, styles.chatHistory, (this.props.maxHeight !== undefined ? { maxHeight: this.props.maxHeight } : {}), (this.props.minHeight !== undefined ? { minHeight: this.props.minHeight } : {}), this.props.containerStyles), onScroll: function (e) { return _this.scrollContainer && _this.scrollContainer.scrollTop <= _this.props.loadOldMessagesThreshold && _this.props.onLoadOldMessages(); } }, this.props.children));
    };
...
var customBubble = function (props) { return (React.createElement("div", null,
    React.createElement("p", null, props.author && props.author.name + ' ' + (props.message.authorId !== props.yourAuthorId ? 'says' : 'said') + ': ' + props.message.message))); };
var Chat = /** @class */ (function (_super) {
    ...
    Chat.prototype.onPress = function (user) {
        this.setState({ currentUser: user });
    };
    Chat.prototype.onMessageSubmit = function (e) {
        var _this = this;
        e.preventDefault();
        if (this.state.messageText !== '') {
            ...
            this.setState(function (previousState) { return ({
                messageText: '',
                messages: previousState.messages.concat(newMessage_1)
            }); }, function () { return _this.chat && _this.chat.onMessageSend(); });
            setTimeout(function () {
                _this.setState(function (previousState) { return ({ messages: previousState.messages.map(function (m) { return m.id === id_1 ? __assign({}, m, { isSend: true }) : m; }) }); });
            }, 2000);
        }
        return true;
    };
        ...
        return (React.createElement("div", { className: "container" },
            ...
            React.createElement("div", { className: "chatfeed-wrapper" },
                ...
                React.createElement("form", { onSubmit: function (e) { return _this.onMessageSubmit(e); } },
                    React.createElement("input", { placeholder: "Type a message...", className: "message-input", value: this.state.messageText, onChange: function (e) { return _this.setState({ messageText: e.target.value }); } })),
                React.createElement("div", { style: { display: 'flex', justifyContent: 'space-around' } },
                    React.createElement("button", { role: "button", style: __assign({}, styles.button, (this.state.currentUser === 0 ? styles.selected : {})), onClick: function () { return _this.onPress(0); } }, "You"),
                    React.createElement("button", { style: __assign({}, styles.button, (this.state.currentUser === 1 ? styles.selected : {})), onClick: function () { return _this.onPress(1); } }, "Mark"),
                    React.createElement("button", { style: __assign({}, styles.button, (this.state.currentUser === 2 ? styles.selected : {})), onClick: function () { return _this.onPress(2); } }, "Evan")),
                React.createElement("div", { style: { display: 'flex', justifyContent: 'space-around', marginTop: 10 } },
                    React.createElement("button", { style: __assign({}, styles.button, (this.state.useCustomBubble ? styles.selected : {})), onClick: function () {
                            return _this.setState({ useCustomBubble: !_this.state.useCustomBubble });
                        } }, "Custom Bubbles"),
                    React.createElement("button", { style: __assign({}, styles.button, (this.state.simulateTyping ? styles.selected : {})), onClick: function () {
                            if (_this.state.simulateTyping) {
                                clearInterval(_this.firstAuthorTimer);
                                clearInterval(_this.secondAuthorTimer);
                            }
                            else {
                                _this.firstAuthorTimer = window.setInterval(function () { return _this.setState({
                                    authors: _this.state.authors.slice(0).map(function (a, i) { return i === 1 ? a : __assign({}, a, { isTyping: !a.isTyping }); })
                                }); }, 2000);
                                _this.secondAuthorTimer = window.setInterval(function () { return _this.setState({
                                    authors: _this.state.authors.slice(0).map(function (a, i) { return i === 2 ? a : __assign({}, a, { isTyping: !a.isTyping }); })
                                }); }, 3200);
                            }
                            _this.setState({ simulateTyping: !_this.state.simulateTyping });
                        } }, "Simulate typing"),
                ...
                React.createElement("div", { style: { display: 'flex', justifyContent: 'space-around', marginTop: 10 } },
                    ...
                    React.createElement("button", { style: __assign({}, styles.button, (this.state.showLastSeen ? styles.selected : {})), onClick: function () { return _this.setState({ showLastSeen: !_this.state.showLastSeen }); } }, "Show last seen"),
...
react_dom_1.render(React.createElement(Chat, null), document.getElementById('chat-ui'));
